...
<div class="container" style="padding-top: 40px;">  
    <div class="card">
            ...
            <div class="card-body">
                    ...
                    <?= Form::model($healths, array('url' => 'healths/edit' . $healths->ha_id, 'method' => 'put','files' => true)) ?>
                    ...
                    <div>    
                            <a href="{{ asset('images/'.$healths->ha_image) }}">
                                <img src="{{ asset('images/resize/'.$healths->ha_image) }}" style="width:100px">
                            </a>                     
                        </div> 
                    <div class="form-group">                             
                        {!! Form::label('ha_image', 'แก้ไขรูปภาพ');  !!}                             
