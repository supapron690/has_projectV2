...
{{-- <div class="container" style="padding-top: 40px;">   --}}
    <div class="card">
            ...
            <div class="card-body">
                    ...
                    <?= Form::model($hospitals, array('url' => 'hospital/edit' . $hospitals->hos_id, 'method' => 'put','files' => true)) ?>
                    ...
                    <div>    
                        <a href="{{ asset('images/'.$hospitals->hos_img) }}">
                            <img src="{{ asset('images/resize/'.$hospitals->hos_img) }}" style="width:100px">
                        </a>                     
                    </div>   
                    <div class="form-group">                             
                        {!! Form::label('hos_img', 'แก้ไขภาพ');  !!}                             
